...
#define RT_I2C_SPACEMIT_K1X
#define RT_USING_PHY_V2
#define RT_USING_ADC
#define RT_ADC_SPACEMIT_PMIC
...
#define RT_SDIO_SDHCI_SPACEMIT_K1X
#define RT_USING_SPI
...
#define RT_SPI_K1X_QSPI
#define RT_SPI_K1X
#define RT_USING_WDT
#define RT_WDT_SPACEMIT_WATCHDOG
#define RT_USING_LCD
#define RT_USING_GRAPHIC
#define RT_GRAPHIC_BACKLIGHT
#define RT_GRAPHIC_BACKLIGHT_PWM
#define RT_GRAPHIC_FB
#define RT_GRAPHIC_FB_ILI9486
...
#define RT_HWCRYPTO_SPACEMIT
#define RT_HWCRYPTO_RNG_SPACEMIT
...
#define RT_INPUT_MISC_PWRKEY_SPACEMIT_PMIC
...
#define RT_NVMEM_SPACEMIT_EFUSE
#define RT_USING_DMA
#define RT_DMA_MMP_PDMA
#define RT_DMA_MMP_PDMA_SUPPORT_64BIT
#define RT_USING_MFD
#define RT_MFD_SYSCON
#define RT_MFD_SPACEMIT_PMIC
#define RT_USING_OFW
...
#define RT_PCI_DW_EP
#define RT_PCI_DW_SPACEMIT_K1X
#define RT_USING_PIC
#define MAX_HANDLERS 1024
#define RT_PIC_RISCV_INTC
#define RT_PIC_SIFIVE_PLIC
#define RT_USING_PINCTRL
#define RT_PINCTRL_SINGLE
#define RT_PINCTRL_SPACEMIT_PMIC
#define RT_USING_PIN
#define RT_PIN_K1X
#define RT_USING_KTIME
#define RT_USING_CLK
#define RT_CLK_SPACEMIT
#define RT_CLK_SPACEMIT_K1X
#define RT_USING_HWTIMER
#define RT_HWTIMER_SPACEMIT_K1X

/* SoC (System on Chip) Drivers */

#define RT_SOC_SPACEMIT_K1X_RPROC
#define RT_SOC_SPACEMIT_K1X_TCM
#define RT_SOC_SPACEMIT_SOCINFO

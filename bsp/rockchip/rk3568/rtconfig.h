...
#define RT_AUDIO_ROCKCHIP
#define RT_AUDIO_ROCKCHIP_I2S
#define RT_AUDIO_ROCKCHIP_I2S_TDM
#define RT_AUDIO_ROCKCHIP_PDM
#define RT_AUDIO_ROCKCHIP_SPDIF
#define RT_USING_CAN
...
#define RT_INPUT_KEYBOARD_GPIO_KEYS
#define RT_INPUT_MISC
#define RT_INPUT_MISC_RK8XX_PWRKEY
#define RT_USING_LED
#define RT_LED_GPIO
...
#define RT_PCI_DW_HOST_ROCKCHIP
#define RT_USING_PHY
#define RT_PHY_ROCKCHIP_NANENG_COMBO
#define RT_PHY_ROCKCHIP_SNPS_PCIE3
#define RT_USING_PIC
...
#define RT_POWER_RESET_SYSCON_REBOOT_MODE
#define RT_POWER_RESET_REBOOT_MODE
#define RT_USING_PWM
...
#define RT_SENSOR_ROCKCHIP_TSADC
...
#define RT_SOC_ROCKCHIP_PMDOMAIN
#define RT_USING_SPI
#define RT_USING_QSPI
#define RT_SPI_ROCKCHIP_SFC

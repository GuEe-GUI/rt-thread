 ...
 *
 * Relationships:
 * - **Consumer side**: device drivers obtain @ref rt_clk handles through
 *   @ref rt_ofw_get_clk() or @ref rt_ofw_get_clk_by_name().
 * - **Provider side**: drivers register clock nodes to the framework via
 *   @ref rt_clk_register().
 *
 * Members:

...
struct rt_blk_disk_ops
{
    rt_ssize_t (*read)(struct rt_blk_disk *, rt_off_t sector, void *buffer,
            rt_size_t sector_count);
    rt_ssize_t (*write)(struct rt_blk_disk *, rt_off_t sector, const void *buffer,
            rt_size_t sector_count);
    rt_err_t (*getgeome)(struct rt_blk_disk *, struct rt_device_blk_geometry *);
    rt_err_t (*sync)(struct rt_blk_disk *);
    rt_err_t (*erase)(struct rt_blk_disk *);
    rt_err_t (*autorefresh)(struct rt_blk_disk *, rt_bool_t);
};

...
struct rt_regulator_ops
{
    ...
    rt_err_t    (*set_mode)(struct rt_regulator_node *, rt_uint32_t mode);
    rt_int32_t  (*get_mode)(struct rt_regulator_node *);
    rt_err_t    (*set_ramp_delay)(struct rt_regulator_node *, int ramp);
    rt_uint32_t (*enable_time)(struct rt_regulator_node *);
};

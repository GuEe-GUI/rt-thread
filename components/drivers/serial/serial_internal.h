...
#ifndef __SERIAL_INTERNAL_H__
#define __SERIAL_INTERNAL_H__
...
#define serial_for_each_args(arg, args)                                 \
    for (char *context = (arg = (typeof(arg))args, (void *)RT_NULL);    \
         !!(arg = rt_strtok_r(arg, ",", &context));                     \
         arg = (!*(arg - 1) ? (*(arg - 1) = ',') : RT_NULL, (typeof(arg))RT_NULL))

#endif /* __SERIAL_INTERNAL_H__ */

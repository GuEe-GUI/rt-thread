...
static rt_err_t scmi_regulator_set_enable(struct scmi_regulator *sreg, rt_bool_t enable)
{
    ...
    struct rt_scmi_msg msg = RT_SCMI_MSG_IN(SCMI_VOLTAGE_DOMAIN_CONFIG_SET, in, out);
...
static rt_bool_t scmi_regulator_is_enabled(struct rt_regulator_node *reg_np)
{
    ...
    struct rt_scmi_msg msg = RT_SCMI_MSG_IN(SCMI_VOLTAGE_DOMAIN_CONFIG_GET, in, out);
        ...
        int min_uvolt, int max_uvolt)
{
    ...
    struct rt_scmi_msg msg = RT_SCMI_MSG_IN(SCMI_VOLTAGE_DOMAIN_LEVEL_SET, in, out);
...
static int scmi_regulator_get_voltage(struct rt_regulator_node *reg_np)
{
    ...
    struct rt_scmi_msg msg = RT_SCMI_MSG_IN(SCMI_VOLTAGE_DOMAIN_LEVEL_GET, in, out);
...
static rt_err_t scmi_regulator_probe(struct rt_scmi_device *sdev)
{
    ...
    struct scmi_regulator *sregs, *sreg;
